...
class InvestmentCompanyView extends StatelessWidget {
  const InvestmentCompanyView({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      ...
      child: const Scaffold(body: InvestmentCompanyBodySection()),
    );
  }
}

class InvestmentCompanyBodySection extends StatelessWidget {
  const InvestmentCompanyBodySection({
    Key? key,
  }) : super(key: key);
